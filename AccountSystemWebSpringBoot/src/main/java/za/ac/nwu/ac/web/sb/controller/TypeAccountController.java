...
public class TypeAccountController {
        ...
        @Autowired
        public TypeAccountController(FetchAccountTypeFlow fetchAccountTypeFlow, @Qualifier("createAccountTypeFlow") CreateAccountTypeFlow createAccountTypeFlow) {
    ...
    public ResponseEntity<GeneralResponse<List<AccountTypeDto>>> getAll() {
        ...
        public ResponseEntity<GeneralResponse<AccountTypeDto>> create(
                ...
                @RequestBody AccountTypeDto typeAccount) {
            AccountTypeDto accountTypeResponse = createAccountTypeFlow.create(typeAccount);
